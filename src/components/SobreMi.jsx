...
import imagenPofolio from "../img/yoImgportfolio.jpg"; // Asegúrate de que la ruta sea correcta
      ...
      <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-10">
        <div className="max-w-[500px] md:max-w-[400px]">
          <p className="">
            ...
            <br /> Aunque en ese entonces era solo un hobby, pronto me di cuenta
            de que quería dedicarme a algo que me permitiera unir mi creatividad
            con la tecnología. Cuando no estoy diseñando, me gusta investigar
            sobre nuevas tecnologías, descubriendo cómo las herramientas
            digitales pueden llevar mi trabajo al siguiente nivel.
          </p>
        </div>
